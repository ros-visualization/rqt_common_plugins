...
class NamesSurrogate(object):
    ...
    def is_global(name):
        ...
        @param name: must be a legal name in canonical form 118 @type name: str 119 
    ...
    def is_private(name):
        ...
        @type name: str 130 @return bool: True if name is a privately referenced name (i.e. ~name) 131 """
    ...
    def ns_join(ns, name):
        ...
        Join a namespace and name. If name is unjoinable (i.e. ~private or 162 /global) it will be returned without joining 163 164
        @param ns: namespace ('/' and '~' are both legal). If ns is the empty string, name will be returned. 165 @type ns: str 166 @param name str: a legal name 167 @return str: name concatenated to ns, or name if it is 168 unjoinable. 169 
        @rtype: str 170
        """
